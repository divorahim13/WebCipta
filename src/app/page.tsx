...
import { Check, Code2, MoveRight } from "lucide-react";
...
export default function Home() {
  ...
  const heroVisual = {
    ...
    visible: {
      ...
      y: 0,
      scale: 1,
      transition: { duration: 0.7, ease: EASE_OUT, delay: shouldReduce ? 0 : 0.35 },
    },
  };

  const heroCard = {
    hidden: { opacity: 0, y: shouldReduce ? 0 : 16, x: shouldReduce ? 0 : 8 },
    visible: {
      opacity: 1,
      y: 0,
      x: 0,
      transition: { duration: 0.55, ease: EASE_OUT, delay: shouldReduce ? 0 : 0.55 },
    },
  };
  ...
  return (
    <>
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden bg-[var(--background)]">
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-b from-[var(--color-secondary-bg)] to-transparent rounded-full blur-3xl opacity-50 -z-10 translate-x-1/3 -translate-y-1/4" />

        {/* Subtle ambient accent — floats gently */}
        <div
          className="absolute top-1/3 left-[5%] w-64 h-64 rounded-full bg-[var(--color-highlight)] opacity-[0.04] blur-3xl -z-10 float-gentle"
            ...
            >
              ...
              <motion.div variants={heroItem}>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 shadow-sm text-[10px] font-bold uppercase tracking-[0.15em] text-[#52525B] mb-8 relative">
                  <span className="absolute -left-[1px] top-1/2 -translate-y-1/2 w-[3px] h-[60%] bg-[var(--color-highlight)]" />
              ...
              <motion.h1
                variants={heroItem}
                className="text-5xl md:text-[68px] font-black font-heading text-[#18181A] leading-[1.05] tracking-tight mb-8"
              >
                Website yang Rapi, Cepat, dan Siap Meningkatkan{" "}
                <span className="text-[var(--color-accent)] relative inline-block">
                  Kepercayaan.
                  <svg
                    className="absolute -bottom-2 md:-bottom-3 left-0 w-full h-3 md:h-4 text-[var(--color-highlight)] opacity-30"
                    viewBox="0 0 100 10"
              ...
              {/* Sub */}
              <motion.p variants={heroItem} className="text-lg text-[#52525B] mb-10 leading-relaxed font-light">
                WebCipta adalah agensi pembuatan website profesional di Cibubur. Kami merancang website yang
                tampil meyakinkan, fungsional, dan dioptimalkan untuk menarik pelanggan bisnis lokal Anda.
              </motion.p>
              ...
              <motion.div variants={heroItem} className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link href="/contact">
                  ...
                  >
                    <Button size="lg" className="w-full sm:w-auto shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                      Mulai Konsultasi
                    </Button>
                  </motion.div>
                </Link>
            ...
            <div className="lg:col-span-6 relative perspective-[1200px] h-[400px] sm:h-[500px]">
              ...
              >
                ...
                <div className="p-4 flex-1">
                  <div className="w-1/3 h-4 bg-gray-700 rounded mb-4" />
              ...
              >
                <div className="h-8 bg-[#F8FAFC] flex items-center px-4 gap-2 border-b border-gray-100 shrink-0">
                  ...
                  <div className="w-2.5 h-2.5 rounded-full bg-gray-300" />
                  <div className="w-2.5 h-2.5 rounded-full bg-gray-300" />
                  <div className="ml-auto w-1/2 h-4 bg-white border border-gray-100 rounded-sm" />
                </div>
                <div className="flex-1 overflow-hidden relative bg-[#FCFBF9]">
                  <div className="flex justify-between items-center p-6 border-b border-gray-100/50">
                    <div className="text-xl font-black tracking-tighter text-[#1C1B1A]">
                      HudBakes<span className="text-[var(--color-highlight)]">.</span>
                    </div>
                  ...
                  <div className="p-8 text-center border-b border-gray-100/50 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-full bg-grid-slate-100 [mask-image:linear-gradient(to_bottom,white,transparent)] opacity-50" />
                    <div className="w-16 h-4 bg-gray-200 rounded mx-auto mb-6" />
                    <div className="w-3/4 h-8 bg-[#1C1B1A] rounded mx-auto mb-3" />
                    <div className="w-1/2 h-8 bg-[#1C1B1A] rounded mx-auto mb-8" />
                    <div className="flex justify-center gap-3 relative z-10">
                      <div className="w-24 h-8 bg-gray-200 rounded-sm" />
                      <div className="w-24 h-8 bg-white border border-gray-200 rounded-sm" />
                    </div>
                  </div>
                </div>
              </motion.div>

              {/* Performance card — floats in last */}
              <motion.div
                variants={heroCard}
                initial="hidden"
                animate={isClient ? "visible" : "hidden"}
              ...
              >
                <div className="w-12 h-12 bg-[#F8FAFC] border border-gray-100 flex items-center justify-center font-black text-lg text-[var(--color-highlight)]">
                  99
                </div>
                <div>
      ...
      <section id="portfolio" className="py-24 bg-[#1C1B1A] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
            <FadeUp>
              <div>
                <h2 className="text-[11px] font-bold tracking-[0.2em] text-[var(--color-highlight)] uppercase mb-4 flex items-center gap-3">
                  <span className="w-8 h-[1px] bg-[var(--color-highlight)]" /> Bukti Kerja
                </h2>
            ...
            <FadeUp delay={0.1}>
              <p className="text-[#94A3B8] font-light max-w-md">
                Hasil desain antarmuka nyata menonjolkan esensi brand lokal dan profesional.
              </p>
            </FadeUp>
          </div>

          <StaggerContainer className="grid md:grid-cols-2 gap-12 lg:gap-16" stagger={0.14}>
            {/* Portfolio 1 */}
            <StaggerItem>
              <motion.div
                className="group"
                ...
                <div className="relative aspect-[4/3] rounded-[2px] bg-[#292827] border border-gray-800 overflow-hidden shadow-2xl mb-6">
                  ...
                  <div className="absolute top-8 left-0 w-full h-[calc(100%-2rem)]">
                    <Image
                      ...
                      fill
                      className="object-cover transform group-hover:scale-[1.025] transition-transform duration-700 ease-out"
                      priority
                    />
                  </div>
                </div>
      ...
      <section className="py-20 bg-[#F8FAFC] border-t border-b border-gray-200/80">
        <div className="container mx-auto px-6 max-w-7xl">
          <FadeUp className="max-w-3xl mb-12">
            <h2 className="text-[11px] font-bold tracking-[0.2em] text-[var(--color-highlight)] uppercase mb-4">
              Fondasi Website
            </h2>
            <h3 className="text-3xl font-bold font-heading text-[#18181A] mb-4">Teknologi yang Kami Gunakan</h3>
            <p className="text-[#52525B] font-light">
              WebCipta membangun website dengan teknologi modern yang ringan, cepat, dan relevan untuk kebutuhan bisnis saat ini.
            </p>
          </FadeUp>

          <StaggerContainer className="grid md:grid-cols-3 gap-8 md:gap-4 lg:gap-8" stagger={0.12} delayChildren={0.05}>
            {/* FRONTEND */}
            <StaggerItem>
              <motion.div
                className="bg-white border border-gray-200 p-6 rounded-md shadow-sm"
                whileHover={shouldReduce ? {} : { y: -3, boxShadow: "0 8px 30px rgb(0,0,0,0.07)" }}
                transition={{ duration: 0.25, ease: EASE_OUT }}
              >
                <h4 className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-wider mb-4 border-b border-gray-100 pb-2">
                  Frontend
                </h4>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <motion.span
                      key={t.name}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#F8FAFC] border border-gray-200 text-[#18181A] text-[12px] font-semibold rounded-sm"
                      whileHover={shouldReduce ? {} : { scale: 1.04, borderColor: "#18181A" }}
                      transition={{ duration: 0.15 }}
                    >
                      <Image src={t.icon} width={16} height={16} alt={t.name} className="opacity-90" />
                      {t.name}
                    </motion.span>
                  ))}
                </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              {/* Floating plaque */}
              <motion.div
                className="absolute -bottom-6 -right-6 lg:-right-12 bg-white border border-gray-200 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] p-6 shrink-0 flex gap-4 max-w-xs transform translate-z-20"
            ...
            >
              <h2 className="text-[11px] font-bold tracking-[0.2em] text-[var(--color-highlight)] uppercase mb-6 flex items-center gap-3">
                <span className="w-8 h-[1px] bg-[var(--color-highlight)]" />
                Pendekatan Kami
              </h2>
              ...
              <p className="text-[#52525B] leading-relaxed mb-6 font-light text-lg">
                Sebagai agensi website butik yang berfokus pada hasil praktis, WebCipta memastikan setiap proyek
                ditangani dengan standar yang tinggi—tanpa birokrasi berbelit. Kepastian biaya, kejelasan struktur,
                dan hasil akhir yang solid adalah janji kami kepada setiap klien bisnis lokal.
              </p>

              <ul className="space-y-4 mt-8 pt-8 border-t border-gray-100">
                {[
                  "Bespoke Design, tidak menggunakan template murahan.",
                  "Struktur yang efisien agar website dimuat dengan cepat.",
                  "Technical SEO dasar disertakan secara bawaan.",
                ].map((item, i) => (
                  <motion.li
                    key={i}
                  ...
                  >
                    ...
                    <span className="text-[#18181A] font-medium">{item}</span>
                  </motion.li>
                ))}
              </ul>
            </motion.div>
      ...
      <section className="py-24 bg-[var(--color-secondary-bg)] border-b border-gray-200/80 overflow-hidden relative">
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-10 pointer-events-none mix-blend-multiply">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-secondary-bg)] to-transparent" />
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="flex justify-between items-end mb-16">
            ...
            <FadeUp delay={0.1} className="hidden md:block">
              <Link href="/about" className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-[#52525B] hover:text-[#18181A] transition-colors">
          ...
          <div className="relative">
            <div className="absolute top-0 bottom-0 left-[19px] md:left-auto md:top-[28px] md:right-0 md:left-[5%] md:h-[1px] md:w-[90%] bg-gray-300" />

            <StaggerContainer
              className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 relative z-10 pl-14 md:pl-0"
              stagger={0.14}
              delayChildren={0.1}
            >
              {[
                ...
                <StaggerItem key={index}>
                  ...
                  >
                    ...
                    <motion.div
                      className="hidden md:flex w-14 h-14 bg-white border-2 border-gray-200 rounded-full items-center justify-center font-bold text-sm font-heading text-[#1C1B1A] mb-8 mx-auto shadow-sm"
                      whileHover={shouldReduce ? {} : { borderColor: "var(--color-accent)", backgroundColor: "#F8FAFC", scale: 1.05 }}
      ...
      <section className="py-24 bg-white relative">
        <div className="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(to_bottom,white,transparent)] -z-10 opacity-40" />

        <div className="container mx-auto px-6 max-w-5xl">
          <motion.div
            className="bg-[#0F172A] rounded-[2px] shadow-2xl p-1 md:p-2"
            initial={{ opacity: 0, y: shouldReduce ? 0 : 30, scale: shouldReduce ? 1 : 0.98 }}
          ...
          >
            <div className="grid md:grid-cols-2 bg-[#1E293B] border border-[#334155] rounded-[1px] overflow-hidden">
              <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-[#334155] relative overflow-hidden flex flex-col justify-center">
                <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-[var(--color-highlight)] to-transparent" />
                <FadeUp inView>
                  <h2 className="text-2xl font-bold font-heading text-white mb-4">
                    Investasi Tanpa Beban Tahunan.
                  </h2>
                  ...
                  <ul className="space-y-4">
                    {["SSL & Cloud CDN Global (Gratis)", "Akses Repositori Original Code"].map((item, i) => (
                      <motion.li
                        key={i}
              ...
              <div className="bg-[#0B1120] p-10 md:p-14 flex flex-col justify-center items-center text-center relative z-10">
                ...
                >
                  <div className="mb-4">
                    <span className="inline-block px-3 py-1 border border-[#334155] bg-[#1E293B] text-[10px] font-bold text-white uppercase tracking-widest mb-6">
                      Mulai Dari
                    </span>
                  </div>
                  <div className="flex items-start gap-1 justify-center mb-6">
                    <span className="text-2xl font-bold text-[#94A3B8] mt-1">Rp</span>
                    <span className="text-6xl md:text-7xl font-black font-heading tracking-tighter text-white">
                      550<span className="text-3xl text-[#94A3B8]">k</span>
                    </span>
                  </div>
                  <p className="text-xs text-[#64748B] mb-10 leading-relaxed max-w-[200px]">
                    Satu Kali Pembayaran.<br />Desain eksklusif hingga 3 Halaman.
                  </p>
                  <Link href="/pricing" className="w-full">
                    <motion.button
                      className="w-full h-12 bg-white text-[#0F172A] font-bold text-[13px] uppercase tracking-widest transition-colors"
                      whileHover={shouldReduce ? {} : { backgroundColor: "#e2e8f0" }}
                      whileTap={shouldReduce ? {} : { scale: 0.97 }}
                      transition={{ duration: 0.15 }}
                    >
      ...
      <section className="py-24 bg-[#FCFBF9] border-t border-gray-200/80">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <FadeUp>
            <div className="w-16 h-1 bg-[var(--color-highlight)] mx-auto mb-10" />
          </FadeUp>
          <FadeUp delay={0.1}>
          ...
          <FadeUp delay={0.3}>
            <Link href="/contact">
              ...
              >
                <Button size="lg" className="shadow-[0_8px_30px_rgb(0,0,0,0.06)] px-12">
                  Reservasi Jam Diskusi
                </Button>
              </motion.div>
            </Link>
          </FadeUp>
